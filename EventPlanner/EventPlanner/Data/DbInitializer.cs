        ...
        public static void Initialize(EventPlannerContext context)
        {
            ...
            var events = new Event[]
            {
                new Event{EventName="Bordspellenavond!",
                    ...
                    Email="shout@teamrockstars.nl",ImageSrc="Bordspel.jpg", EventType = EventType.Recreation, ForEmployees=true},
                ...
                new Event{EventName="Pizzasessie IT Rockstar Sven Haster | Four easy steps to migrate to JPMS",
                    ...
                    Email="shout@teamrockstars.nl",ImageSrc="SvenHaster.jpg", EventType = EventType.Educational, ForEmployees=false},
                ...
                new Event{EventName="IT Rockstar Christiaan Nieuwlaat | Modulaire Software Ontwikkeling – Chapter Lower South",
                    ...
                    Email="shout@teamrockstars.nl",ImageSrc="ChristiaanNieuwlaat.jpg", EventType = EventType.Educational, ForEmployees=false},
                ...
                new Event{EventName="Pizzasessie IT Rockstar Bart Kardol | Digitalisering verandert de wereld, ook op zee",
                    ...
                    Email="shout@teamrockstars.nl",ImageSrc="BartKardol.jpg", EventType = EventType.Educational, ForEmployees=false},
            };
